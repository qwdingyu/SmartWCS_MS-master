...
{
    /// <summary>
    /// ResetPassword.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ResetPassword : Window, IDisposable
    {
        #region ▩ Delegate
        ...
        public ResetPassword(string _strUserID, string _strCenterCD)
        {
            try
            {
                InitializeComponent();
        ...
        private void InitEvent()
        {
            ...
            {
                // Loaded 이벤트
                this.Loaded += ResetPassword_Loaded;
