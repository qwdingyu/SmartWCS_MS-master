...
using SMART.WCS.UI.Optimization.Views.QPS;
using System;
...
namespace SMART.WCS.Main
{
    ...
    /// 로그인
    /// </summary>
    public partial class _Login : Window
    {
        #region ▩ 전역변수
        /// <summary>
        /// Base Class
        ...
        public _Login(DataTable _dtDatabaseConnectionInfo)
        {
            InitializeComponent();
        ...
        private void BtnTest_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            using (OPT0107_QPS_01P frmPopup = new OPT0107_QPS_01P(strUploadNo))
            {
