...
namespace SMART.WCS.UI.Common.WebService_Coupang {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WebService_Coupang.ICoupangWebService")]
    public interface ICoupangWebService {
        ...
        SMART.WCS.UI.Common.WebService_Coupang.LiveUpdateMember GetServerFileListInfo(string _strAppName, System.Collections.Generic.Dictionary<string, string> _dicLocalVersion);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICoupangWebService/GetServerFileListInfo", ReplyAction="http://tempuri.org/ICoupangWebService/GetServerFileListInfoResponse")]
        System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.LiveUpdateMember> GetServerFileListInfoAsync(string _strAppName, System.Collections.Generic.Dictionary<string, string> _dicLocalVersion);
        ...
        SMART.WCS.UI.Common.WebService_Coupang.DeployServerFileInfo GetDeployServerFileInfo(string _strAppName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICoupangWebService/GetDeployServerFileInfo", ReplyAction="http://tempuri.org/ICoupangWebService/GetDeployServerFileInfoResponse")]
        System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.DeployServerFileInfo> GetDeployServerFileInfoAsync(string _strAppName);
        ...
        SMART.WCS.UI.Common.WebService_Coupang.CompositeType GetDataUsingDataContract(SMART.WCS.UI.Common.WebService_Coupang.CompositeType composite);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICoupangWebService/GetDataUsingDataContract", ReplyAction="http://tempuri.org/ICoupangWebService/GetDataUsingDataContractResponse")]
        System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.CompositeType> GetDataUsingDataContractAsync(SMART.WCS.UI.Common.WebService_Coupang.CompositeType composite);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICoupangWebServiceChannel : SMART.WCS.UI.Common.WebService_Coupang.ICoupangWebService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CoupangWebServiceClient : System.ServiceModel.ClientBase<SMART.WCS.UI.Common.WebService_Coupang.ICoupangWebService>, SMART.WCS.UI.Common.WebService_Coupang.ICoupangWebService {
        ...
        public SMART.WCS.UI.Common.WebService_Coupang.LiveUpdateMember GetServerFileListInfo(string _strAppName, System.Collections.Generic.Dictionary<string, string> _dicLocalVersion) {
            return base.Channel.GetServerFileListInfo(_strAppName, _dicLocalVersion);
        }
        
        public System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.LiveUpdateMember> GetServerFileListInfoAsync(string _strAppName, System.Collections.Generic.Dictionary<string, string> _dicLocalVersion) {
            return base.Channel.GetServerFileListInfoAsync(_strAppName, _dicLocalVersion);
        }
        
        public SMART.WCS.UI.Common.WebService_Coupang.DeployServerFileInfo GetDeployServerFileInfo(string _strAppName) {
            return base.Channel.GetDeployServerFileInfo(_strAppName);
        }
        
        public System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.DeployServerFileInfo> GetDeployServerFileInfoAsync(string _strAppName) {
        ...
        public SMART.WCS.UI.Common.WebService_Coupang.CompositeType GetDataUsingDataContract(SMART.WCS.UI.Common.WebService_Coupang.CompositeType composite) {
            return base.Channel.GetDataUsingDataContract(composite);
        }
        
        public System.Threading.Tasks.Task<SMART.WCS.UI.Common.WebService_Coupang.CompositeType> GetDataUsingDataContractAsync(SMART.WCS.UI.Common.WebService_Coupang.CompositeType composite) {
