...
namespace SMART.WCS.UI.COMMON.DataMembers.C1010
{
    class DetailCommonCodeMgmt : PropertyNotifyExtensions, IDXDataErrorInfo
    {
        ...
        {
            this.Error = null;
            this.SetErrorInfo(new ErrorInfo(), null, ErrorType.None);
        }
        ...
        #region + COM_DTL_CD - 상세 코드
        private string _COM_DTL_CD;
        public string COM_DTL_CD
        {
            get { return this._COM_DTL_CD; }
            set
            {
                if (this._COM_DTL_CD != value)
                {
                    this._COM_DTL_CD = value;
                    RaisePropertyChanged();
                }
            }
        }
        ...
        #region + COM_DTL_NM - 상세 코드 이름
        private string _COM_DTL_NM;
        public string COM_DTL_NM
        {
            get { return this._COM_DTL_NM; }
            set
            {
                if (this._COM_DTL_NM != value)
                {
                    this._COM_DTL_NM = value;
                    RaisePropertyChanged();
                }
            }
        }
