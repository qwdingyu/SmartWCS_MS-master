...
namespace SMART.WCS.UI.Analysis.DataMembers.A2001
{
    ...
    public class MasterView : PropertyNotifyExtensions, IDXDataErrorInfo
    {
        ...
        #region * 분류상세명 - CFG_DTL_NAME
        private string _CFG_DTL_NAME;
        /// <summary>
        /// 분류상세명
        /// </summary>
        public string CFG_DTL_NAME
        {
            get { return this._CFG_DTL_NAME; }
            set
            {
                if (this._CFG_DTL_NAME != value)
                {
                    this._CFG_DTL_NAME = value;
                    RaisePropertyChanged();
                }
            }
        }
